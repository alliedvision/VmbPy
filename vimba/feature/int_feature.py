...
from vimba.c_binding import VmbInt64
...
class IntFeature(BaseFeature):
    ...
    def get(self):
        ...
        call_vimba_c_func('VmbFeatureIntGet', self._handle, self._info.name,
                          byref(c_val))
    ...
    def get_range(self):
        ...
        call_vimba_c_func('VmbFeatureIntRangeQuery', self._handle,
    ...
    def get_increment(self):
        ...
        call_vimba_c_func('VmbFeatureIntIncrementQuery', self._handle,
                          self._info.name, byref(c_val))

        return c_val.value

    def set(self, val: int):
        call_vimba_c_func('VmbFeatureIntSet', self._handle, self._info.name,
                          val)
