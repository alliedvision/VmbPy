...
from vimba.c_binding import VmbHandle, VmbUint32, VmbFeatureInfo
...
class StringFeature(BaseFeature):
    ...
    def get(self) -> str:
        ...
        call_vimba_c_func('VmbFeatureStringGet', self._handle, self._info.name, c_buf, c_buf_len,
                          None)

        return c_buf.value.decode()

    def set(self, val: str):
        call_vimba_c_func('VmbFeatureStringSet', self._handle, self._info.name, val.encode('uft-8'))
