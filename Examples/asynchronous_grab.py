...
def setup_camera(cam):
    ...
    # If OpenCV is installed, set pixel format to a OpenCV compatible format
    # to avoid later conversion.
    if cv2 is not None:
        # Query available formats, prefer color formats over monochrome formats
